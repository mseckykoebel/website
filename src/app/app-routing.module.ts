...
const appRoutes: Routes = [
  ...
  {
    path: "blog_posts_adaptive_learning_the_data",
    component: AdaptiveLearningTheDataComponent
  },
  { path: "blog_home_page", component: BlogHomePageComponent },
  {
    path: "blog_posts_adaptive_learning",
    component: AdaptiveLearningComponent
  },
  {
    path: "blog_posts_adaptive_learning_the_good_and_the_conclusion",
    component: AdaptiveLearningTheGoodAndTheConclusionComponent
  },
